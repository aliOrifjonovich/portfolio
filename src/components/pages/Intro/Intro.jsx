    ...
    <div className={styles.about_intro}>
        <div className={styles.about_intro__container}>
            ...
            <div className={styles.about_intro__description}>
                ...
                <p data-aos='fade-right' data-aos-delay='400'>Passionate front-end Developer with more than 1.5+ years of experience in developing highly adaptive and responsive websites using React.js and TypeScript.</p>
